  ...
  return (
        ...
        <div className={styles.card}>
          <div className={styles.card_items}>
            ...
            <div className={styles.card_content}>
              <p className={styles.card_para}>I am Frontend Developer working with React Js, JavaScript, Html,Css, scss,and next-js I have Created some projects in above mentions You will find them Here{" "} <Link href="/projects">Portfolio</Link></p>
    <p className={styles.card_para}>
      ...
      Here I have Building some cool Things.
                          ...
                          <p className={styles.card_para}>About my Hobbies I like to watch Animes Movies, Travelling,
